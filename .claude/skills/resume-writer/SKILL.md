---
name: resume-writer
description: "基于 SuperBizAgent 项目生成定制化简历项目经历。结合项目技术亮点与用户业务场景，按简历编写原则输出高质量项目描述（中英文）。Use when user says '写简历', 'resume', '简历', 'write resume', '项目经历', 'project experience', '简历项目', or asks to generate resume content based on this project."
---
...
2. 按需深读 [references/Architecture.md](references/Architecture.md)中的内容或源码补充模块细节
...
**问题 1 — 目标岗位**（单选）：
- Backend Engineer / AI Agent应用 / LLM Application Engineer / Agent Engineer / 全栈 AI
- 决定：技术关键词策略、亮点筛选优先级
...
**问题 3 — 技术侧重**（多选）：
- Hybrid Search / Rerank / MCP 协议 / Harness engineering / Multi-agent协作 / 评估体系 / Function Calling / Agent 扩展 / Agent memory
